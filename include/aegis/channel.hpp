...
#pragma region rest params
    struct create_message_t
    {
        ...
        create_message_t& user_id(aegis::snowflake param) { _user_id = param; return *this; }
    ...
    {
        edit_message_t& message_id(aegis::snowflake param) { _message_id = param; return *this; }
    ...
    struct get_messages_t
    {
        ...
        get_messages_t& message_id(aegis::snowflake param) { _message_id = param; return *this; }
    ...
    struct modify_channel_t
    {
        ...
        modify_channel_t& permission_overwrites(const std::vector<aegis::gateway::objects::permission_overwrite>& param)
        {
            _permission_overwrites = param; return *this;
        }
        modify_channel_t& parent_id(aegis::snowflake param) { _parent_id = param; return *this; }
        ...
        lib::optional<aegis::snowflake> _parent_id = {};
        lib::optional<int> _rate_limit_per_user = {};
    };

    struct create_reaction_t
    {
        create_reaction_t& message_id(aegis::snowflake param) { _message_id = param; return *this; }
    ...
    {
        delete_user_reaction_t& message_id(aegis::snowflake param) { _message_id = param; return *this; }
        delete_user_reaction_t& emoji_text(const std::string& param) { _emoji_text = param; return *this; }
        delete_user_reaction_t& member_id(aegis::snowflake param) { _member_id = param; return *this; }
        aegis::snowflake _message_id;
        std::string _emoji_text;
        aegis::snowflake _member_id;
    };

    struct get_reactions_t
    {
        get_reactions_t& message_id(aegis::snowflake param) { _message_id = param; return *this; }
    ...
    {
        edit_channel_permissions_t& overwrite_id(aegis::snowflake param) { _overwrite_id = param; return *this; }
...
#pragma endregion
    ...
    public:
        ...
        /**
         * @param channel_id aegis::snowflake of this channel
         * @param guild_id aegis::snowflake of guild this channel belongs to
         ...
         */
        AEGIS_DECL channel(const aegis::snowflake channel_id, const aegis::snowflake guild_id, core* _bot, asio::io_context& _io, ratelimit::ratelimit_mgr& _ratelimit);
        ...
        /// Get aegis::snowflake of the last message sent
        /**
         * @returns aegis::snowflake of the last message sent in this channel
         */
        aegis::snowflake get_last_message_id() const noexcept
        {
         ...
         */
        aegis::gateway::objects::channel::channel_type get_type() const noexcept
        {
            return type;
        }
        ...
        /// Get bot's aegis::permission for this channel
        /**
         * @returns Bitmask of current aegis::permissions for this channel contained within `aegis::permission` object
         */
        AEGIS_DECL aegis::permission perms() const noexcept;

        /// Get rate limit per user of this channel
        /**
         * Bots and users with the aegis::permission to manage messages or manage channel, are unaffected by this rate limit
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> create_message(const std::string& content, int64_t nonce = 0);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> create_message(aegis::create_message_t obj);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> create_message_embed(const std::string& content, const json& embed, int64_t nonce = 0);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> create_message_embed(create_message_t obj);

        /// Get message from this channel
        /**
         * @param message_id aegis::snowflake of the message to retrieve
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> get_message(aegis::snowflake message_id);

        /// Get multiple messages from this channel
        /**
         * @see aegis::get_messages_t
         * @param obj Struct of the request
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::messages>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::messages> get_messages(get_messages_t obj);


        /// Edit a message in this channel
        /**
         * @param message_id aegis::snowflake of the message to replace. Must be your own message
         * @param content A string of the message to set
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> edit_message(aegis::snowflake message_id, const std::string& content);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> edit_message(edit_message_t obj);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> edit_message_embed(aegis::snowflake message_id, const std::string& content, const json& embed);
         ...
         * @returns LSW::v5::Tools::Future<aegis::gateway::objects::message>
         */
        AEGIS_DECL LSW::v5::Tools::Future<aegis::gateway::objects::message> edit_message_embed(edit_message_t obj);

        /// Delete a message
        /**
         * @param message_id aegis::snowflake of the message to delete
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_message(aegis::snowflake message_id);
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> bulk_delete_message(const std::vector<int64_t>& messages);

        /// Delete up to 100 messages at once
        /**
         * @param message Vector of up to 100 message aegis::snowflakes to delete
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> bulk_delete_message(const std::vector<aegis::snowflake>& messages);
         ...
         * @param _aegis::permission_overwrites Vector of aegis::permission_overwrite objects for overriding aegis::permissions
         * @param _parent_id aegis::snowflake of category channel belongs in (empty parent puts channel in no category)
         * @returns LSW::v5::Tools::Future<gateway::objects::channel>
         */
        AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::channel> modify_channel(lib::optional<std::string> _name = {},
            lib::optional<int> _position = {}, lib::optional<std::string> _topic = {},
            lib::optional<bool> _nsfw = {}, lib::optional<int> _bitrate = {},
            lib::optional<int> _user_limit = {},
            lib::optional<std::vector<gateway::objects::permission_overwrite>> _permission_overwrites = {},
            lib::optional<aegis::snowflake> _parent_id = {}, lib::optional<int> _rate_limit_per_user = {});
         ...
         * @returns LSW::v5::Tools::Future<gateway::objects::channel>
         */
        AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::channel> modify_channel(modify_channel_t obj)
        {
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_channel();

        /// Add new reaction on message
        /**
         * @param message_id aegis::snowflake of message
         * @param emoji_text Text of emoji being added `name:aegis::snowflake`
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> create_reaction(aegis::snowflake message_id, const std::string& emoji_text);
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> create_reaction(create_reaction_t obj)
        {
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_own_reaction(aegis::snowflake message_id, const std::string& emoji_text);
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_own_reaction(delete_own_reaction_t obj)
        {
         ...
         * @param message_id aegis::snowflake of message
         * @param emoji_text Text of emoji being added `name:aegis::snowflake`
         * @param member_id aegis::snowflake of member to remove emoji from
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_user_reaction(aegis::snowflake message_id, const std::string& emoji_text, aegis::snowflake member_id);
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_user_reaction(delete_user_reaction_t obj)
        {
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> get_reactions(aegis::snowflake message_id, const std::string& emoji_text);
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> get_reactions(get_reactions_t obj)
        {
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_all_reactions(aegis::snowflake message_id);

        /// Edit channel aegis::permission override
        /**
         * @param _overwrite_id aegis::snowflake of the aegis::permission override
         * @param _allow Int64 allow flags
         * @param _deny Int64 deny flags
         * @param _type Type of override (role/user)
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> edit_channel_permissions(aegis::snowflake _overwrite_id, int64_t _allow, int64_t _deny, const std::string& _type);

        /// Edit channel aegis::permission override
        /**
         * @see aegis::edit_channel_aegis::permissions_t
         * @param obj Struct of the contents of the request
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> edit_channel_permissions(edit_channel_permissions_t obj)
        {
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> get_channel_invites();
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> create_channel_invite(const lib::optional<int> max_age,
         ...
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> create_channel_invite(create_channel_invite_t obj)
        {
            return create_channel_invite(obj._max_age, obj._max_uses, obj._temporary, obj._unique);
        }

        /// Delete channel aegis::permission override
        /**
         * @param overwrite_id aegis::snowflake of the channel aegis::permission to delete
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_channel_permission(aegis::snowflake overwrite_id);

        /// Trigger typing indicator in channel (lasts 10 seconds)
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> trigger_typing_indicator();

        /// Get pinned messages in channel
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> get_pinned_messages();

        /// Add a pinned message in channel
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> add_pinned_channel_message(aegis::snowflake message_id);

        /// Delete a pinned message in channel
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_pinned_channel_message(aegis::snowflake message_id);

        /// Add member to a group direct message
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> group_dm_add_recipient(aegis::snowflake user_id);

        /// Remove member from a group direct message
        /**
         * @returns LSW::v5::Tools::Future<rest::rest_reply>
         */
        AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> group_dm_remove_recipient(aegis::snowflake user_id);
        ...
        /// Get parent channel aegis::snowflake
        /**
         * @returns aegis::aegis::snowflake
         */
        ...
        /// Get the aegis::aegis::snowflake of this channel
        /**
         * @returns An aegis::aegis::snowflake of the channel
         */
        aegis::snowflake get_id() const noexcept
        {
            return channel_id;
        }

        /// Get the aegis::snowflake of this channel's guild - 0 if DM
        /**
         * @returns A aegis::snowflake of this channel's guild
         */
        aegis::snowflake get_guild_id() const noexcept
        {
            return guild_id;
        }
        ...
        /**
         * @returns Returns a std::std::shared_mutex reference for the channel object
         */
        std::shared_mutex& mtx() const noexcept
        {
            return _m;
        }
    ...
    private:
        ...
        aegis::snowflake channel_id; /**< aegis::snowflake of this channel */
        aegis::snowflake guild_id; /**< aegis::snowflake of the guild this channel belongs to */
        guild* _guild; /**< Pointer to the guild this channel belongs to */
        aegis::snowflake parent_id; /**< aegis::snowflake of the parent channel */
        aegis::snowflake last_message_id = 0; /**< aegis::snowflake of the last message sent in this channel */
        ...
        std::unordered_map<int64_t, gateway::objects::permission_overwrite> overrides; /**< aegis::snowflake map of user/role to aegis::permission overrides */
