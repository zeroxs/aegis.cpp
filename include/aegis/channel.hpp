...
struct modify_channel_t
{
    ...
    std::optional<bool> _nsfw = {};
    std::optional<int> _bitrate = {};
    std::optional<int> _user_limit = {};
    std::optional<std::vector<gateway::objects::permission_overwrite>> _permission_overwrites = {};
    std::optional<snowflake> _parent_id = {};
    std::optional<int> _rate_limit_per_user = {};
};
...
struct create_channel_invite_t
{
    ...
    std::optional<int> _max_uses;
    std::optional<bool> _temporary;
...
public:
     ...
     */
    AEGIS_DECL async::task<gateway::objects::message> create_message(const std::string & content, int64_t nonce = 0);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> create_message(create_message_t obj);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> create_message_embed(const std::string & content, const json & embed, int64_t nonce = 0);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> create_message_embed(create_message_t obj);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> get_message(snowflake message_id);

    /// Get multiple messages from this channel
    /**
     * @see aegis::get_messages_t
     * @param obj Struct of the request
     * @returns async::task<gateway::objects::messages>
     */
    AEGIS_DECL async::task<gateway::objects::messages> get_messages(get_messages_t obj);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> edit_message(snowflake message_id, const std::string & content);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> edit_message(edit_message_t obj);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> edit_message_embed(snowflake message_id, const std::string & content, const json & embed);
     ...
     * @returns async::task<gateway::objects::message>
     */
    AEGIS_DECL async::task<gateway::objects::message> edit_message_embed(edit_message_t obj);
     ...
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_message(snowflake message_id);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> bulk_delete_message(const std::vector<int64_t> & messages);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> bulk_delete_message(const std::vector<snowflake> & messages);
     ...
     */
    AEGIS_DECL async::task<gateway::objects::channel> modify_channel(std::optional<std::string> _name = {},
        std::optional<int> _position = {}, std::optional<std::string> _topic = {},
        std::optional<bool> _nsfw = {}, std::optional<int> _bitrate = {},
        std::optional<int> _user_limit = {},
        std::optional<std::vector<gateway::objects::permission_overwrite>> _permission_overwrites = {},
        std::optional<snowflake> _parent_id = {}, std::optional<int> _rate_limit_per_user = {});
     ...
     * @returns async::task<gateway::objects::channel>
     */
    AEGIS_DECL async::task<gateway::objects::channel> modify_channel(modify_channel_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_channel();
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> create_reaction(snowflake message_id, const std::string & emoji_text);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> create_reaction(create_reaction_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_own_reaction(snowflake message_id, const std::string & emoji_text);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_own_reaction(delete_own_reaction_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_user_reaction(snowflake message_id, const std::string & emoji_text, snowflake member_id);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_user_reaction(delete_user_reaction_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> get_reactions(snowflake message_id, const std::string & emoji_text);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> get_reactions(get_reactions_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_all_reactions(snowflake message_id);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> edit_channel_permissions(snowflake _overwrite_id, int64_t _allow, int64_t _deny, const std::string & _type);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> edit_channel_permissions(edit_channel_permissions_t obj)
    {
    ...
    */
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> get_channel_invites();
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> create_channel_invite(const std::optional<int> max_age,
        const std::optional<int> max_uses,
        const std::optional<bool> temporary,
        const std::optional<bool> unique);
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> create_channel_invite(create_channel_invite_t obj)
    {
     ...
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_channel_permission(snowflake overwrite_id);

    /// Trigger typing indicator in channel (lasts 10 seconds)
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> trigger_typing_indicator();

    /// Get pinned messages in channel
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> get_pinned_messages();

    /// Add a pinned message in channel
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> add_pinned_channel_message(snowflake message_id);

    /// Delete a pinned message in channel
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> delete_pinned_channel_message(snowflake message_id);

    /// Add member to a group direct message
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> group_dm_add_recipient(snowflake user_id);

    /// Remove member from a group direct message
    /**
     * @returns async::task<rest::rest_reply>
     */
    AEGIS_DECL async::task<rest::rest_reply> group_dm_remove_recipient(snowflake user_id);
