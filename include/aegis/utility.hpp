...
constexpr inline Duration to_t(const std::chrono::duration<int_type, ratio> & t)
{
...
constexpr inline Duration to_t(const T & t)
{
...
constexpr inline S to_ms(const std::chrono::duration<S, ratio> & t)
{
...
constexpr inline typename T::rep to_ms(const T & t)
{
